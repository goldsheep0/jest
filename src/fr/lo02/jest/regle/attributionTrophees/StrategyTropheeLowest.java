...
public class StrategyTropheeLowest implements StrategyTrophee {
	...
	public Joueur execute(ArrayList<Joueur> joueurs) {
		...
		Valeur valeurMin=Valeur.QUATRE;
		...
		while(itJoueur.hasNext()) {
			...
			while(itJest.hasNext()) {
				...
				if(currentCarte.getCouleur()==this.couleur) {
					if(currentCarte.getValeur().ordinal()<=valeurMin.ordinal()) {
						valeurMin=currentCarte.getValeur();
	...
	public static void main(String[] args) {
		...
		cont.addCarte(new Carte(Valeur.AS, Couleur.PIQUE, new StrategyTropheeLowest(Couleur.PIQUE)));
		...
		cont.addCarte(new Carte(Valeur.TROIS, Couleur.PIQUE, new StrategyTropheeLowest(Couleur.PIQUE)));
		...
		cont.addCarte(new Carte(Valeur.QUATRE, Couleur.PIQUE, new StrategyTropheeLowest(Couleur.PIQUE)));
		cont.addCarte(new Carte(Valeur.JOKER, Couleur.JOKER, new StrategyTropheeNull()));

		cont.melanger();
		
		Carte trophee = new Carte(Valeur.DEUX, Couleur.PIQUE, new StrategyTropheeLowest(Couleur.PIQUE));
